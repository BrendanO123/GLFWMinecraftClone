...
Block :: Block(char minX, char maxX, char minY, char maxY, bool transparent, bool billboard, bool solid, bool waterLogable, bool traslucent){
    ...
    flagByte = 
        ...
        (traslucent ? Blocks :: TRANSLUCENT_BIT : 0);
}
...
Block :: Block(
    ...
    bool transparent, bool billboard, bool solid, bool waterLogable, bool traslucent){
