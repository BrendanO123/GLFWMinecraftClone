...
Block :: Block(char minX, char maxX, char minY, char maxY, bool transparent, bool billboard, bool waterLogable, bool traslucent){
    ...
    flagByte = (transparent ? Blocks :: TRANSPARENT_BIT : 0) + (billboard ? Blocks :: BILLBOARD_BIT : 0) + (waterLogable ? Blocks :: WATER_LOGABLE_BIT : 0) + (traslucent ? Blocks :: TRANSLUCENT_BIT : 0);
}
...
Block :: Block(
    ...
    bool transparent, bool billboard, bool waterLogable, bool traslucent){
