...
namespace Structures{
    ...
    const vector<vector<GLubyte>> StructsData = {
        ...
        {//pond
            ...
            AIR, AIR, AIR,  AIR,   AIR,   AIR,   AIR,   AIR,   AIR,   AIR,   AIR,   AIR,   AIR,  AIR,  AIR, AIR,
            AIR, AIR, AIR,  AIR,   AIR,   AIR,   AIR,   SAND,  SAND,  AIR,   AIR,   AIR,   AIR,  AIR,  AIR, AIR,
            AIR, AIR, AIR,  AIR,   AIR,   AIR,   SAND,  SAND,  SAND,  SAND,  AIR,   AIR,   AIR,  AIR,  AIR, AIR,
            AIR, AIR, AIR,  AIR,   AIR,   SAND,  SAND,  WATER, WATER, SAND,  SAND,  AIR,   AIR,  AIR,  AIR, AIR,
            AIR, AIR, AIR,  AIR,   SAND,  WATER, WATER, WATER, WATER, WATER, SAND,  SAND,  AIR,  AIR,  AIR, AIR,
            AIR, AIR, AIR,  SAND,  WATER, WATER, WATER, WATER, WATER, WATER, WATER, SAND,  SAND, AIR,  AIR, AIR,
