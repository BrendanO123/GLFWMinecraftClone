...
$(TARGET) : $(OBJS) $(ENTRY) $(GL_OBJ) $(SRCS_H) $(SELF)
...
$(OBJ_PATH)%.o : $(SRC_PATH)%.cpp
	@$(CXX) $(CXXFLAGS) $(CPPVERSION) -MMD -MP -c -o $@ $< -I$(INCLUDE)
