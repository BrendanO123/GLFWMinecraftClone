...
To compile the project with makefile run ```make``` in the root directory of the project. Additionally, ```make build``` and ```make run``` can be used to compile without .o files, and compile and run, respectively.
